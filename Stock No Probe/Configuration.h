...
#define STRING_CONFIG_H_AUTHOR "Some dude from Facebook" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sovol SV01 Bugfix"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 86.88
  #define DEFAULT_bedKi 11.92
  #define DEFAULT_bedKd 422.27
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -33, 0, 5 }
